#!/bin/bash
#SBATCH --job-name=epi_16kwiki     # create a short name for your job
...
echo "champsim_epi_16k:wiki.gz"
bin/champsim_epi_16k \
  --warmup_instructions 200000000 \
  --simulation_instructions 1000000000 \
  /scratch/user/nitisha/Traces/wikipedia.gz \
  > results/epi_16k/wiki.txt
